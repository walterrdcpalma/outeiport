...
export default function SimulatePage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold text-blue-900 mb-2">ISV Simulator</h1>
      <p className="text-slate-500 mb-8">
        Paste a mobile.de listing link and get an instant ISV estimate for importing
        the vehicle to Portugal.
      </p>
